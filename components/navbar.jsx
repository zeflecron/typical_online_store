          ...
          >
            <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              <li
                ...
                className="cursor-pointer flex flex-row py-2 pr-4 pl-3 text-white hover:bg-green-400 border-b md:hover:bg-transparent md:border-0 md:hover:text-black md:p-0"
              >
                <BsFillMoonStarsFill className="text-xl mr-2" /> Dark Mode
              </li>
              <li>
                <Link
                  href="/"
